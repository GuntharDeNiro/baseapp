...
import { OrderProps, WalletItemProps } from '../../../components';
import {
    alertPush,
    RootState,
    selectCurrentPrice,
...
import { SimpleOrder } from '../../components';
...
class SimpleOrderInsert extends React.PureComponent<Props, StoreProps> {
...
const SimpleOrderComponent = injectIntl(connect(mapStateToProps, mapDispatchToProps)(SimpleOrderInsert as any)) as any;
