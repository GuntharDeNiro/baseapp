...
import { SimpleOrderProps } from '../SimpleOrder';

// tslint:disable:no-magic-numbers jsx-no-lambda jsx-no-multiline-js
type OnSubmitCallback = (order: SimpleOrderProps) => void;
...
interface SimpleOrderFormState {
...
const checkButtonIsDisabled = (safeAmount: number, safePrice: number, price: string, props: SimpleOrderFormProps, state: SimpleOrderFormState) => {
...
export class SimpleOrderForm extends React.Component<SimpleOrderFormProps, SimpleOrderFormState> {
    constructor(props: SimpleOrderFormProps) {
        super(props);
        this.state = {
            orderType: 'Market',
            amount: '',
    ...
    public componentWillReceiveProps(next: SimpleOrderFormProps) {
