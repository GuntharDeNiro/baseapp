...
export type OnSubmitCallback = (order: SimpleOrderProps) => void;

export interface SimpleOrderComponentProps {
    /**
...
class SimpleOrder extends React.PureComponent<SimpleOrderComponentProps> {
    public render() {
        const {
            width = defaultWidth,
        } = this.props;
